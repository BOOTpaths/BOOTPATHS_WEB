/* ==========================================
   BOOTPATHS – GOECHALA PASS HIMALAYAN EXPEDITION JAVASCRIPT
   MULTI-DEVICE RESPONSIVE UX, ACCORDIONS, GALLERY & BOOKING
   ========================================== */
...
// Close menu when clicking navigation links & initialize sticky navbar
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Update initial checklist count
  updateChecklistCount();
});

// -------------------------------------------------------------
// 2. ACCORDIONS (MAIN SECTIONS, ITINERARY DAYS & FAQS)
// -------------------------------------------------------------
...
function updateChecklistCount() {
  ...
  if (badge) {
    ...
    if (checked === total && total > 0) {
      ...
      badge.textContent = `All ${total} Items Packed! Ready for Goecha La!`;
    } else {
