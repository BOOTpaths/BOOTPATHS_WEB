/* ==========================================
   BOOTPATHS – PARAMBIKULAM TIGER RESERVE TREK
   INTERACTIVE CLIENT UX & RESPONSIVE LOGIC
   ========================================== */

'use strict';

// -------------------------------------------------------------
// 1. MOBILE NAVIGATION & BACKDROP (iOS & Android optimized)
// -------------------------------------------------------------
function toggleMenu() {
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Sticky Navbar blur and elevation on scroll
  ...
  // Initialize checklist counter
  updateChecklistCount();
});

// -------------------------------------------------------------
// 2. ACCORDIONS (ITINERARY & FAQS)
// -------------------------------------------------------------
...
// -------------------------------------------------------------
// 4. GALLERY LIGHTBOX & CATEGORY FILTERING
// -------------------------------------------------------------
